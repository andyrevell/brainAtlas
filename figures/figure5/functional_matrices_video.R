...
options(scipen=999)#stop R from reading numbers as scientific notation. Helps with readin ghte long times from iEEG org verbatim rather than sci notation
