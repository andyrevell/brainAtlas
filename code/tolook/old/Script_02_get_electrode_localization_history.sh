...
#python3.6 -c 'import Script_02_get_electrode_localization as el; el.batch_compute_dist_from_grey(["RID0139", "RID0194", "RID0278","RID0309","RID0320","RID0365","RID0394","RID0420","RID0440"])'
#python3.6 -c 'import Script_02_get_electrode_localization as el; el.batch_compute_dist_from_grey(["RID0454"])' #RID0454 originally had error where coordinate was outside of voxel index. Fixed now.
#python3.6 -c 'import Script_02_get_electrode_localization as el; el.batch_compute_dist_from_grey(["RID0476","RID0490","RID0502","RID0508","RID0520","RID0522","RID0529","RID0536","RID0583"])'
#python3.6 -c 'import Script_02_get_electrode_localization as el; el.batch_localize_electrodes_one_atlas(["RID0194","RID0278","RID0320","RID0309","RID0365","RID0139","RID0490","RID0502","RID0508","RID0420","RID0522","RID0520","RID0454","RID0536","RID0529","RID0595"],"JHU_aal_combined_res-1x1x1")'
#595 didn't have csv 
python3.6 -c 'import Script_02_get_electrode_localization as el; el.batch_localize_electrodes_one_atlas(["RID0440"],"JHU_aal_combined_res-1x1x1")'
