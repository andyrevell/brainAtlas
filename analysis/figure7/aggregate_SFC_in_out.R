...
output_directory= "/gdrive/public/USERS/arevell/papers/paper001/data_processed/figure7_data/processed_in_out_analysis_jhu_aal/"
...
class_atlases = c("aal_res-1x1x1","JHU_res-1x1x1")
cur_count = 1
#SFC Random Atlases
...
names(all_processed_data) = c("aal_res-1x1x1_inside","aal_res-1x1x1_outside","JHU_res-1x1x1_inside","JHU_res-1x1x1_outside")
...
save(all_processed_data,file = paste(output_directory,"sub-",sub_ID,"_",iEEG_filename,"_ICTAL_",ictal_time[1], "_SFC_All_Atlases_Class_by_aal_jhu.RData",sep="")) #sub-RID0278_HUP138_phaseII_ICTAL_ 416023190000 _SFC_All_Atlases.RData")   
