...
pdf(file.path(ofpath_network_measures, "network_measures.pdf"), width = 10, height = 5)


plot_standard = T #indicate whether or not to plot the standard atlases

#Random Atlases
data_random = read.csv(file.path(ifpath_network_measures,"network_measures_random_atlas.csv"), stringsAsFactors = F, header = T)
...
#Standard Atlases
data_standard = read.csv(file.path(ifpath_network_measures,"network_measures_standard_atlas"), stringsAsFactors = F, header = T)
