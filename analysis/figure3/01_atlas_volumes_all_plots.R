...
figure_directory = "/Users/andyrevell/Documents/20_papers/paper001_brainAtlasChoiceSFC/figures/"
...
pdf(paste0(figure_directory, "figure3/figure3_atlas_standard_volumesVSsphericity.pdf"), width = 10, height = 7)
