...
#plot_averaged_resampled_data <- function(averaged_resampled_data_path, output_plot_path){
  ...
  for (f in INDEX_FREQ){
    ...
    for (a in 1:length(standard_atlases_to_plot)){
      ...
      data_interictal_broadband_movingAvg = ma(averaged_resampled_standard_atlases[[atlas_index]]$interictal[[f]], N)
      data_other_broadband_movingAvg = ma( c(averaged_resampled_standard_atlases[[atlas_index]]$preictal[[f]], 
                                             averaged_resampled_standard_atlases[[atlas_index]]$ictal[[f]], 
                                             averaged_resampled_standard_atlases[[atlas_index]]$postictal[[f]]  ), N  )
