...
for (a in 1:(length(atlases))){
  ...
  for (p in 1:(length(perm))){
    ...
    data_postictal_file_name = paste0('sub-', sub_ID, '_' , iEEG_filename, '_', postictal_time[1], '_', postictal_time[2], '_', atlas_folder ,'_Perm', sprintf('%04d',perm[p]),'_correlation.pickle')
