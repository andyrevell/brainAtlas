...
output_directory= "/Users/andyrevell/mount/USERS/arevell/papers/paper001/paper001/figures/figure5/"
...
fname = paste0(output_directory, '/Figure5C_sub-', sub_ID, '_', iEEG_filename,  '_ICTAL_', ictal_start_time,".pdf")
...
ylim = c(-0.1, 0.6)
standard_atlases_line_width = 7
random_atlases_line_width = 7
...
legend("right", inset=c(-0.1,0), legend = rev( standard_atlases_legend), fill = rev( standard_atlas_colors), bty = 'n', bg ='n',horiz = F,
