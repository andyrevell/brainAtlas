...
#Andy computer:
processed_SFC_dir = "/Users/andyrevell/mount/USERS/arevell/papers/paper001/data_processed/figure7_data/in_out_analysis/"
resampled_SFC_dir = "/Users/andyrevell/mount/USERS/arevell/papers/paper001/data_processed/figure7_data/average_SFC_ALL_PATIENTS/medians/all/"
...
for(cur_file in all_files){
  ...
  all_lengths = c(all_lengths,length(all_processed_data[[1]][[1]][[3]][[1]][[1]]))
}
