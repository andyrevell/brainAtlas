...
class_atlases = ['aal_res-1x1x1','JHU_res-1x1x1']
                    ...
                    if (os.path.exists(function_file_path)) == False:
                        ...
                        if (os.path.exists(electrode_localization_by_atlas_file_path))==False:
                            ...
                            if (os.path.exists(outputfile_directory_cur))==False:
                                ...
                                get_structure_function_correlation.SFC_by_class_atlas(structure_file_path,function_file_path,electrode_localization_by_atlas_file_path, electrode_localization_by_class_atlas_file_path, outputfile)
                            else:
