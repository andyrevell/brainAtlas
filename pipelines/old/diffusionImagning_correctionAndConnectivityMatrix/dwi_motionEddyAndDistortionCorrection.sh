...
#ALEX, RUN THIS:
# sh dwi_motionEddyAndDistortionCorrection.sh /gdrive/public/DATA/Human_Data/BIDS_new /gdrive/public/TOOLS/atlases_and_templates/templates /gdrive/public/DATA/Human_Data/BIDS_processed_data RID0529 preop3T
